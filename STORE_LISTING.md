...
Free compass, level & offline maps. No ads, no trackers, open source.
(70 characters)

## Full description (4000 char max)

A simple, honest compass app — no ads, no account, no tracking of any kind.
...
- No user-generated content, no ads, no account/social features, no in-app purchases
- Collects location (for core app functionality) but does not share or sell it
- No data collection, so most "data safety" form sections should be answerable as "no data collected"
